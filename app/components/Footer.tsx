...
const Footer = () => {
  return (
    <footer className="w-full bg-white text-gray-900 border-t-2 border-gray-300 relative z-10">
      <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-10 px-6 pb-12 border-b border-gray-300">    
        
        {/* Brand / Logo Section */}
        <div className="flex flex-col mt-2 md:mt-0">
          <Logo />
          <p className="mt-6 text-base leading-relaxed">
            <span className="font-bold text-lg">Story Snatcher</span> empowers learners and professionals with 
            AI-driven tools for fast transcriptions, clear summaries, interactive flashcards, and 
            personalized quizzes. Transform hours of content into minutes of effective study.
          </p>
        </div>
        ...
        <div className="mt-24 md:mt-0">
          ...
          <ul className="space-y-4">
            {[
              ...
              { name: 'Flashcards', href: '/services/flashcards' },
              { name: 'Quizzes', href: '/services/quizzes' },
